            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <template v-if="all_terms_of_use && all_terms_of_use.length !== 0 && !isLoading">
                    <tr v-for="terms_of_use in filter_terms_of_use" :key="terms_of_use.id" class="bg-white border-b hover:bg-gray-100">
                        ...
                        <td v-if="terms_of_use.deleted_at === null" class="px-6 py-4">
                            <button @click="destroyTermsOfUse(terms_of_use.id, true)" class="px-6 py-4 text-blue-400 hover:text-blue-600 ">
                        ...
                        <td v-if="terms_of_use.deleted_at !== null" class="px-6 py-4">
                            <button @click="destroyTermsOfUse(terms_of_use.id, false)" class="px-6 py-4 text-red-400 hover:text-red-600 ">
...
const destroyTermsOfUse = async (id, status) => {
