    ...
    <div class="flex flex-col mt-6 w-full">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <template v-if="allPartner && allPartner.length !== 0 && !isLoading">
...
<!--                        </td>-->
                        ...
                        <td v-if="partner.deleted_at === null" class="px-6 py-4">
                            <button @click="destroyPartner(partner.id, true)" class="px-6 py-4 text-blue-400 hover:text-blue-600 ">
                        ...
                        <td v-if="partner.deleted_at !== null" class="px-6 py-4">
                            <button @click="destroyPartner(partner.id, false)" class="px-6 py-4 text-red-400 hover:text-red-600 ">
                ...
                <template v-else-if="(!allPartner || allPartner.length <= 0) && !isLoading">
                    <tr>
            ...
            <div class="flex justify-center items-center mx-auto w-full">
                <section v-if="allPartner && allPartner.length !== 0 && meta.total > 5" class="py-2 w-full bg-white flex justify-center items-center mx-auto">
...
const { allPartner, publishPartner, restorePartner, fetchPartner, deletePartner, isLoading, meta } = usePartner();

onMounted(fetchPartner);

function paginate(pageNum){
    pageNumber.value = pageNum;
    fetchPartner(pageNum);
}
...
const destroyPartner = async (id, status) => {
