...
<!--                    </th>-->
                ...
                <tbody>
                <template v-if="allService && allService.length > 0">
...
<!--                        </td>-->
                        ...
                        <td class="px-6 py-4 text-center">
                            <router-link :to="{name:'edit_service', params:{id: service.id}}" class="text-blue-400 hover:text-blue-600">
                                <i class="fas fa-edit cursor-pointer mr-1"></i>Edit</router-link>
                        </td>
                        <td class="px-6 py-4">
                            <button @click="showService(service.id)" class="text-blue-400 hover:text-blue-600">
...
const { allService, restoreService, publishService, fetchService, deleteService, notification } = useService();
