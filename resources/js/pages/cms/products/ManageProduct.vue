...
<!--                    </th>-->
                ...
                <tbody>
                <template v-if="allProduct && allProduct.length > 0">
...
<!--                        </td>-->
                        ...
                        <td class="px-6 py-4 text-center">
                            <router-link :to="{name:'edit_product', params:{id: product.id}}" class="text-blue-400 hover:text-blue-600">
                                <i class="fas fa-edit cursor-pointer mr-1"></i> Edit </router-link>
                        </td>
                        <td class="px-6 py-4">
                            <button @click="showProduct(product.id)" class="text-blue-400 hover:text-blue-600">
                        ...
                        <td v-if="product.deleted_at === null" class="px-6 py-4">
                            <button @click="destroyProduct(product.id)" class="px-6 py-4 text-blue-400 hover:text-blue-600 ">
                        ...
                        <td v-if="product.deleted_at !== null" class="px-6 py-4">
                            <button @click="destroyProduct(product.id)" class="px-6 py-4 text-red-400 hover:text-red-600 ">
...
const { allProduct, restoreProduct, publishProduct, fetchProduct, deleteProduct, notification } = useProduct();
