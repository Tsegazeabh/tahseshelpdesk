...
<!--                    </th>-->
                ...
                <tbody>
                <template v-if="all_privacy_policy && all_privacy_policy.length > 0">
...
<!--                        </td>-->
                        ...
                        <td class="px-6 py-4 text-right">
                            <router-link :to="{name:'edit_privacy_policy', params:{id: privacy_policy.id}}" class="text-blue-400 hover:text-blue-600">
                                <i class="fas fa-edit cursor-pointer mr-1"></i> Edit </router-link>
                        </td>
                        <td class="px-6 py-4">
                            <button @click="showPrivacyPolicy(privacy_policy.id)" class="text-blue-400 hover:text-blue-600">
...
const { all_privacy_policy, restorePrivacyPolicy, publishPrivacyPolicy,fetchPrivacyPolicy, deletePrivacyPolicy, notification } = usePrivacyPolicy();
