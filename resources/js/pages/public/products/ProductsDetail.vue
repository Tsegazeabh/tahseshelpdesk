    ...
    <home-layout>
        <div class="grid grid-cols-3">
            ...
            <div class="col-span-3 md:col-span-1 pt-16 px-4 bg-gray-100 mb-0 pb-0">
                ...
                <div v-if="allProduct && allProduct.length !== 0" class="overflow-x-hidden overflow-y-auto space-y-4 max-h-[70vh] w-full bg-gray-200 rounded-md p-2">
...
const { product, allProduct, getProduct, fetchProduct } = usePublicProduct();
