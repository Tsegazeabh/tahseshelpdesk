...
//carousel
    Route::prefix('carousels')->group(function (){
        ...
        Route::get('preview/{id}',[\App\Http\Controllers\Api\cms\CarouselController::class,'preview']);
    });
...
//company information
Route::get('company',[\App\Http\Controllers\Api\cms\ContactUsController::class,'fetch']);
Route::post('company/update',[\App\Http\Controllers\Api\cms\ContactUsController::class,'store']);
